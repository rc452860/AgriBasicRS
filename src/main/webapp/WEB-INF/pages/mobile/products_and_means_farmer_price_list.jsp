...
<head>
  ...
  <script type="text/javascript">
    window.deleteUrl = "/mobile/productsAndMeansFarmerPrice/delete";
    window.deleteMulUrl = "/mobile/productsAndMeansFarmerPrice/deleteMulit";
  </script>
...
<div class="place">
  ...
  <ul class="placeul">
    ...
    <li><a href="#">主要农产品和农业生产资料价格监测旬报表(农民售价)列表</a></li>
  </ul>
</div>
...
<div class="rightinfo">
  ...
  <div class="tools">
    ...
    <ul class="toolbar">
      <li onclick="window.location.href='/mobile/productsAndMeansFarmerPrice/add'" class="click"><span><img
  ...
  <table class="tablelist">
    ...
    <c:forEach var="item" items="${list}">
      ...
      <tr>
        ...
        <td><a href="/mobile/productsAndMeansFarmerPrice/edit?id=${item.id}" class="tablelink">修改/查看</a> <a
  ...
  <div class="pagin">
    ...
    $('#pageGro').pagination({
      ...
      callback: function (index) {
        window.location.href = "/mobile/productsAndMeansFarmerPrice/list?page=" + index;
      }
    });
    </script>
  </div>
