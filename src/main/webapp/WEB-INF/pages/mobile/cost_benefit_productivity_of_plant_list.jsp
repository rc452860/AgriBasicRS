  ...
  <script type="text/javascript">
    function Delete(id) {/*删除脚本*/
      $.ajax({
        cache: false,
        type: "POST",
        url: "/mobile/costBenefitProductivityOfPlant/delete", /*此处需修改*/
        data: {'id': id},
        async: false,
    ...
    function DeleteMulit() {
      ...
      $.ajax({
        cache: false,
        type: "POST",
        url: "/mobile/costBenefitProductivityOfPlant/deleteMulit", /*此处需修改*/
        data: {ids: arr},
        async: false,
        error: function (XMLHttpRequest) {
          alert("error:" + XMLHttpRequest.status);
...
<div class="rightinfo">
  ...
  <div class="tools">
    ...
    <ul class="toolbar">
      <li onclick="window.location.href='/mobile/costBenefitProductivityOfPlant/add'" class="click"><span><img
