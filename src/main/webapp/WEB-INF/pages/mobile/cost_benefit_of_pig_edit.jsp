...
<div class="formbody">
  ...
  <form:form commandName="CostBenefitOfPigForm">
    <form:hidden path="costBenefitOfPig.id"/>
    <div id="usual1" class="usual">
      ...
      <div id="tab1" class="tabson"><%--联系方式--%>
        <ul class="forminfo">
          <li><label>调查表编号<b>*</b></label><form:input path="costBenefitOfPig.registration_form_id" name="" type="text" class="dfinput" value=""
                                                      style="width:518px;"/></li>

          <li><label>调查县数<b>*</b></label><form:input path="costBenefitOfPig.county_num" name="" type="text" class="dfinput" value=""
                                                     style="width:518px;"/></li>
          <li><label>调查户数<b>*</b></label><form:input path="costBenefitOfPig.family_num" name="" type="text" class="dfinput" value=""
                                                     style="width:518px;"/></li>
          <li><label>调查头数<b>*</b></label><form:input path="costBenefitOfPig.head_num" name="" type="text" class="dfinput" value=""
                                                     style="width:518px;"/></li>

          <li><label>平均饲养时间<b>*</b></label><form:input path="costBenefitOfPig.average_feeding_time" name="" type="text" class="dfinput" value=""
                                                       style="width:518px;"/></li>
    ...
    $(function () {
      $('#submit_button').click(function () {
        $.ajax({
          cache: false,
          type: "POST",
          url: "/mobile/costBenefitOfPig/edit",
