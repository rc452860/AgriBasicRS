...
<div class="formbody">
    <form:form commandName="WholeYearPlantAreaForm">
        <table class="form-add" cellpadding="0" cellspacing="0">
            <tr>
                <td>调查表编号</td>
                <td><form:input class="easyui-combobox" required="true" data-options="url:'/mobile/registrationForm/selectJsonB/WholeYearPlantArea',
					method:'get',
					valueField:'id',
					textField:'text',
            ...
            <tr>
                ...
                <td>豆类合计</td>
                <td><form:input path="food_legume" validType="gte['food_legume_dadou']" class="easyui-numberbox" data-options="precision:2"/></td>
            </tr>
            <tr>
                <td>马铃薯</td>
            ...
            <tr>
                <td>烟叶</td>
                <td><form:input path="tobacco_total" validType="gte['tobacco_kaoyan']" class="easyui-numberbox" data-options="precision:2"/></td>
                <td>烤烟</td>
            ...
            <tr>
                <td>其他作物</td>
                <td><form:input path="otherplant_total" validType="gte['otherplant_qingsiliaol']" class="easyui-numberbox" data-options="precision:2"/></td>
                <td>青饲料</td>
