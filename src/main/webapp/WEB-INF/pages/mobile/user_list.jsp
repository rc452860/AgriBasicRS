    ...
    <script type="text/javascript">
        ...
        function DeleteMulit() {
            ...
            $.ajax({
                cache: false,
                type: "POST",
                url: "/mobile/user/deleteMulit", /*此处需修改*/
                data: {ids: arr},
                async: false,
                error: function (XMLHttpRequest) {
                    alert("error:" + XMLHttpRequest.status);
...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <li onclick="window.location.href='/mobile/user/add'" class="click"><span><img
    ...
    <table class="tablelist">
        ...
        <c:forEach var="item" items="${list}">
            ...
            <tr>
                ...
                <td><my:ctp code="${item.regionCode}"/></td>
                <td>${item.name}</td>
                <td>${item.username}</td>
                <td><a href="/mobile/user/edit?id=${item.id}" class="tablelink">修改/查看</a> <a
    ...
    <div class="pagin">
        ...
        $('#pageGro').pagination({
            ...
            callback: function (index) {
                window.location.href = "/mobile/user/list?page=" + index;
            }
        });
        </script>
    </div>
