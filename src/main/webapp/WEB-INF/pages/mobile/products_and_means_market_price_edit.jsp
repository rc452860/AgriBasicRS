...
<div class="formbody">
  ...
  <form:form commandName="ProductsAndMeansMarketPriceForm">
    <form:hidden path="productsAndMeansMarketPrice.id"/>
    <div id="usual1" class="usual">
      ...
      <div id="tab1" class="tabson"><%--联系方式--%>
        <ul class="forminfo">
          <li><label>调查表编号<b>*</b></label><form:input path="productsAndMeansMarketPrice.registration_form_id" name="" type="text" class="dfinput" value=""
    ...
    $(function () {
      $('#submit_button').click(function () {
        $.ajax({
          cache: false,
          type: "POST",
          url: "/mobile/productsAndMeansMarketPrice/edit",
