...
<div class="formbody">
    ...
    <form:form commandName="AutumnFoodExpecProForm">
        <table class="form-add" cellpadding="0" cellspacing="0">
            <tr>
                <td>调查表编号</td>
                <td><form:input class="easyui-combobox" required="true" data-options="url:'/mobile/registrationForm/selectJsonB/autumnFoodExpecPro',
					method:'get',
					valueField:'id',
					textField:'text',
    ...
    <script type="text/javascript">
        $(function () {
            $('#submit_button').click(function () {
                if( $('#AutumnFoodExpecProForm').form("validate")){
                    $.ajax({
                        cache: false,
                        type: "POST",
                        url: "/mobile/autumnFoodExpecPro/add",
