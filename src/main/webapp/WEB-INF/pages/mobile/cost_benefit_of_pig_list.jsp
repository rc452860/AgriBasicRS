...
<head>
    ...
    <script type="text/javascript">
        window.deleteMulUrl = "/mobile/costBenefitOfPig/deleteMulit";
        window.deleteUrl = "/mobile/costBenefitOfPig/delete";
    </script>
...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <li onclick="window.location.href='/mobile/costBenefitOfPig/add'" class="click"><span><img
    ...
    <table class="tablelist">
        ...
        <c:forEach var="item" items="${list}">
            ...
            <tr>
                ...
                <td><a href="/mobile/costBenefitOfPig/edit?id=${item.id}" class="tablelink">修改/查看</a> <a
    ...
    <div class="pagin">
        ...
        $('#pageGro').pagination({
            ...
            callback: function (index) {
                window.location.href = "/mobile/costBenefitOfPig/list?page=" + index;
            }
        });
        </script>
    </div>
