 ...
 */
public class WholeYearPlantAreaForm {
    private String id;
    ...
    public WholeYearPlantArea getWholeYearPlantArea() throws NoSuchFieldException, IllegalAccessException {
        WholeYearPlantArea wholeYearPlantArea = new WholeYearPlantArea();
        Field[] formFileds = this.getClass().getDeclaredFields();
        Class  entityClass = wholeYearPlantArea.getClass();
        for (Field field : formFileds){
            field.setAccessible(true);
            Field entityField = entityClass.getDeclaredField(field.getName());
            entityField.setAccessible(true);
            entityField.set(wholeYearPlantArea,field.get(this));
        }
        return wholeYearPlantArea;
    }


    public static WholeYearPlantAreaForm WholeYearPlantAreaToForm(WholeYearPlantArea wholeYearPlantArea) throws NoSuchFieldException, IllegalAccessException {
        WholeYearPlantAreaForm wholeYearPlantAreaForm = new WholeYearPlantAreaForm();
        Field[] wholeYearPlantAreaFields = wholeYearPlantArea.getClass().getDeclaredFields();
